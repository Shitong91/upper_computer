...
public:
	...
	{
		LPDISPATCH result;
		InvokeHelper(0xf2, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
	...
	{
		LPDISPATCH result;
		InvokeHelper(0xf4, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
	LPDISPATCH get_asLinePoint()
	{
		LPDISPATCH result;
		InvokeHelper(0xf5, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
	...
	{
		LPDISPATCH result;
		InvokeHelper(0xf8, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
	LPDISPATCH get_asErrorPoint3D()
	{
		LPDISPATCH result;
		InvokeHelper(0xf9, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
